...
export const translations = {
  es: {
    ...
    'index.trafficLedeGood': 'Ahora mismo, el <strong style="color:{color}">{pct}%</strong> de Madrid circula con fluidez.',
    'index.trafficLedeMedium': 'El <strong style="color:{color}">{pct}%</strong> de las calles de Madrid circula con normalidad.',
    'index.trafficLedeHigh': 'Atención: el <strong style="color:{color}">{pct}%</strong> de las calles está congestionado.',
    'index.trafficLedePerfect': 'Madrid circula con <strong style="color:#2D6A4F">total fluidez</strong>.',
    'index.trafficLedeDetail': '{congested} de {total} sensores detectan congestión.',
    'index.trafficHotspotsSummary': 'calles congestionadas ahora',
    'index.trafficSourceLink': 'Fuente',
    ...
    'scorecard.trafficTitle': 'Tráfico en',
    'scorecard.trafficLoading': 'Cargando datos de tráfico...',
    'scorecard.trafficScore': 'score movilidad',
    'scorecard.trafficWorst': 'Calles con congestión',
  ...
  en: {
    ...
    'index.trafficLedeGood': 'Right now, <strong style="color:{color}">{pct}%</strong> of Madrid\'s streets flow freely.',
    'index.trafficLedeMedium': '<strong style="color:{color}">{pct}%</strong> of Madrid\'s streets are flowing normally.',
    'index.trafficLedeHigh': 'Warning: <strong style="color:{color}">{pct}%</strong> of streets are congested.',
    'index.trafficLedePerfect': 'Madrid is flowing with <strong style="color:#2D6A4F">complete ease</strong>.',
    'index.trafficLedeDetail': '{congested} of {total} sensors detect congestion.',
    'index.trafficHotspotsSummary': 'congested streets right now',
    'index.trafficSourceLink': 'Source',
    ...
    'scorecard.trafficTitle': 'Traffic in',
    'scorecard.trafficLoading': 'Loading traffic data...',
    'scorecard.trafficScore': 'mobility score',
    'scorecard.trafficWorst': 'Congested streets',
