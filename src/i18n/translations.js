...
export const translations = {
  es: {
    ...
    'index.trafficWorstTitle': 'Calles más congestionadas ahora',
    'index.trafficDistrictsTitle': 'Tráfico por distrito',
    'index.trafficCongestedPct': 'congestión',
    'map.legendTrafico': 'Tráfico',
    'map.legendFluido': 'Fluido',
    'map.legendDenso': 'Denso',
    'map.legendCongestionado': 'Congestionado',
    'map.legendCortado': 'Cortado',
    'map.legendTraficoFooter': '~4.000 sensores · cada 5 min',
    'map.tooltipTrafficLevel': 'Nivel',
    'map.tooltipTrafficIntensity': 'Intensidad',
    'map.tooltipTrafficLoad': 'Carga',
  ...
  en: {
    ...
    'index.trafficWorstTitle': 'Most congested streets right now',
    'index.trafficDistrictsTitle': 'Traffic by district',
    'index.trafficCongestedPct': 'congestion',
    'map.legendTrafico': 'Traffic',
    'map.legendFluido': 'Free flow',
    'map.legendDenso': 'Dense',
    'map.legendCongestionado': 'Congested',
    'map.legendCortado': 'Blocked',
    'map.legendTraficoFooter': '~4,000 sensors · every 5 min',
    'map.tooltipTrafficLevel': 'Level',
    'map.tooltipTrafficIntensity': 'Intensity',
    'map.tooltipTrafficLoad': 'Load',
